...
df_1<- read.table(file = file_path, head= TRUE, stringsAsFactors = FALSE, sep = " ", comment.char ="#" )
dim(df)
...
```{r}
cv.lm(data = df_1, mult_m, m=10, dots = FALSE, seed=29, plotit=TRUE, printit=TRUE)
```
